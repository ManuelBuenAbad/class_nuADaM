...
//mba_idr_rsa
class_precision_parameter(idr_streaming_trigger_tau_over_tau_eq,double,6.0) /**< when to switch on dark radiation (idr) free-streaming approximation, third condition */
//mba_idr_rsa
